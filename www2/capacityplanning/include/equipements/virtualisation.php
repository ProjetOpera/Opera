...
?>
	<table class="tableau_meteo">
	  	...
	  	<tr>
			<td><a href="./id_menu=239&type=data_center&target=data_center" target="_self">Virtualisation</a></td><td><img src="images/pluvieux.png"></td>
		</tr>
	</table>
...
?>
	<table class="tableau_meteo">
	  	...
	  	<tr>
	  		<td><a href="./id_menu=239&type=data_center&target=SNP1_clus1" target="_self">NUTAMPPRD</td><td><img src="images/soleil.png"></td>
	  	</tr>
	  	<tr>
			<td><a href="./id_menu=239&type=data_center&target=SNP1_clus2" target="_self">ORAAMPPRD</td><td><img src="images/pluvieux.png"></td>
		</tr>
		<tr>
			<td><a href="./id_menu=239&type=data_center&target=SNP1_clus3" target="_self">VSPAMPRD</td><td><img src="images/pluvieux.png"></td>
		</tr>
		<tr>
			<td><a href="./id_menu=239&type=data_center&target=SNP1_clus4" target="_self">VSPPRDSII</td><td><img src="images/pluvieux.png"></td>
		</tr>
	</table>
	<a href="./id_menu=239&type=data_center&target=data_center" target="_self">Retour</a>
<?php
	}
?>
...
?>
	<table class="tableau_meteo">
	  	...
	  	<tr>
	  		<td><a href="./id_menu=239&type=data_center&target=SNP2_clus1" target="_self">NUTAMPPRD</td><td><img src="images/soleil.png"></td>
	  	</tr>
	  	<tr>
			<td><a href="./id_menu=239&type=data_center&target=SNP2_clus2" target="_self">ORAAMPPRD</td><td><img src="images/pluvieux.png"></td>
		</tr>
		<tr>
			<td><a href="./id_menu=239&type=data_center&target=SNP2_clus3" target="_self">VSPAMPRD</td><td><img src="images/pluvieux.png"></td>
		</tr>
		<tr>
			<td><a href="./id_menu=239&type=data_center&target=SNP2_clus4" target="_self">VSPPRDSII</td><td><img src="images/pluvieux.png"></td>
		</tr>
	</table>
	<a href="./id_menu=239&type=data_center&target=data_center" target="_self">Retour</a>
<?php
