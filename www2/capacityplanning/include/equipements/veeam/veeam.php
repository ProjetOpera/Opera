...
?>
	<table class="tableau_meteo">
	  	...
	  	<tr>
	  		<td><a href="http://localhost/capacityplanning/id_menu=228&type=veeam&target=SNP1" target="_self">Veeam</a></td><td><img src="images/nuageux.png"></td><td><a href="http://localhost/capacityplanning/id_menu=228&type=veeam&target=SNP2" target="_self">Veeam</a></td><td><img src="images/soleil.png">
	  	</tr>
	</table>	
